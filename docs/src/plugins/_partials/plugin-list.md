...
| [Format Strings (fmtlog)](/plugins/fmtlog) | Opt the logger into `fmt.Sprintf`-style format strings: `log.Info("user %d", id)` resolves to `"user 1234"` before downstream hooks see it. |
