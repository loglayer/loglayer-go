...
All notable changes to `go.loglayer.dev/transports/phuslu` are documented here.
Format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/);
versioning follows [SemVer](https://semver.org/spec/v2.0.0.html).

Releases are managed by [Release Please](https://github.com/googleapis/release-please)
from conventional commits scoped to `transports/phuslu`. Tags use the
prefixed form `transports/phuslu/v<X.Y.Z>` so this module versions
independently of the framework core.

## [1.6.1](https://github.com/loglayer/loglayer-go/compare/transports/phuslu/v1.3.0...transports/phuslu/v1.6.1) (2026-04-30)
...
## [1.3.0](https://github.com/loglayer/loglayer-go/compare/transports/phuslu/v1.2.0...transports/phuslu/v1.3.0) (2026-04-30)
...
## [1.2.0](https://github.com/loglayer/loglayer-go/compare/transports/phuslu/v1.1.0...transports/phuslu/v1.2.0) (2026-04-29)
...
## [1.1.0](https://github.com/loglayer/loglayer-go/compare/transports/phuslu/v1.0.0...transports/phuslu/v1.1.0) (2026-04-29)
...
[Unreleased]: https://github.com/loglayer/loglayer-go/commits/main/transports/phuslu
