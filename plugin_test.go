...
func TestPlugin_OnBeforeDataOut_AddsKeys(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewDataHook("add-keys", func(p loglayer.BeforeDataOutParams) loglayer.Data {
...
func TestPlugin_OnBeforeMessageOut_RewritesMessages(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewMessageHook("uppercase", func(p loglayer.BeforeMessageOutParams) []any {
...
func TestPlugin_TransformLogLevel_OverridesLevel(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewLevelHook("promote-to-warn", func(p loglayer.TransformLogLevelParams) (loglayer.LogLevel, bool) {
...
func TestPlugin_ShouldSend_VetoesPerTransport(t *testing.T) {
	...
	log.AddPlugin(loglayer.NewSendGate("skip-drop-transport", func(p loglayer.ShouldSendParams) bool {
...
func TestPlugin_OnMetadataCalled_RewritesMetadata(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewMetadataHook("redact-password", func(metadata any) any {
...
func TestPlugin_OnFieldsCalled_RewritesFields(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewFieldsHook("uppercase-keys", func(fields loglayer.Fields) loglayer.Fields {
...
func TestPlugin_MultiplePlugins_RunInRegistrationOrder(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewMessageHook("first", func(p loglayer.BeforeMessageOutParams) []any {
		return []any{"first"}
	}))
	log.AddPlugin(loglayer.NewMessageHook("second", func(p loglayer.BeforeMessageOutParams) []any {
...
func TestPlugin_ReplaceByID(t *testing.T) {
	log, _ := setup(t)
	log.AddPlugin(loglayer.NewPlugin("p1"))
	log.AddPlugin(loglayer.NewPlugin("p1")) // replace, not add
...
func TestPlugin_RemovePlugin(t *testing.T) {
	log, _ := setup(t)
	log.AddPlugin(loglayer.NewPlugin("to-remove"))
...
func TestPlugin_GetPlugin(t *testing.T) {
	log, _ := setup(t)
	log.AddPlugin(loglayer.NewPlugin("lookup"))
...
func TestPlugin_AddPlugin_AutoGeneratesEmptyID(t *testing.T) {
	...
	log.AddPlugin(loglayer.NewDataHook("",
		func(_ loglayer.BeforeDataOutParams) loglayer.Data { return nil }))
...
func TestPlugin_ChildInheritsPlugins(t *testing.T) {
	parent, lib := setup(t)
	parent.AddPlugin(loglayer.NewDataHook("marker", func(p loglayer.BeforeDataOutParams) loglayer.Data {
...
func TestPlugin_ChildPluginIsolation(t *testing.T) {
	parent, lib := setup(t)
	child := parent.Child()
	child.AddPlugin(loglayer.NewDataHook("child-only", func(p loglayer.BeforeDataOutParams) loglayer.Data {
...
func TestPlugin_TransformLogLevel_DroppedByLevelFilter(t *testing.T) {
	...
	log.AddPlugin(loglayer.NewLevelHook("demote", func(p loglayer.TransformLogLevelParams) (loglayer.LogLevel, bool) {
...
func TestPlugin_BeforeDataOut_SeesError(t *testing.T) {
	log, lib := setup(t)
	var sawError bool
	log.AddPlugin(loglayer.NewDataHook("see-error", func(p loglayer.BeforeDataOutParams) loglayer.Data {
...
func TestPlugin_DispatchHooksReceiveCtx(t *testing.T) {
	...
	log, _ := setup(t)
	log.AddPlugin(&allHooksCtxCapture{
	...
	for g := 0; g < adders; g++ {
		...
		go func() {
			...
			for i := 0; i < iters/4; i++ {
				...
				log.AddPlugin(loglayer.NewMessageHook(id, func(p loglayer.BeforeMessageOutParams) []any {
					return p.Messages
				}))
				log.RemovePlugin(id)
			}
...
func TestPlugin_OnBeforeDataOut_NilPreservesData(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewDataHook("no-op", func(p loglayer.BeforeDataOutParams) loglayer.Data {
		return nil
	}))
...
func TestPlugin_OnFieldsCalled_NilDropsFields(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewFieldsHook("drop-fields", func(fields loglayer.Fields) loglayer.Fields {
		return nil
	}))
...
func TestPlugin_OnFieldsCalled_Chain(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewFieldsHook("first", func(fields loglayer.Fields) loglayer.Fields {
		out := make(loglayer.Fields, len(fields))
		for k, v := range fields {
			out["A_"+k] = v
		}
	...
	log.AddPlugin(loglayer.NewFieldsHook("second", func(fields loglayer.Fields) loglayer.Fields {
		out := make(loglayer.Fields, len(fields))
		for k, v := range fields {
			out["B_"+k] = v
		}
...
func TestPlugin_OnMetadataCalled_NilShortCircuits(t *testing.T) {
	log, _ := setup(t)
	secondCalled := false
	log.AddPlugin(loglayer.NewMetadataHook("drop", func(metadata any) any {
		return nil
	}))
	log.AddPlugin(loglayer.NewMetadataHook("after-drop", func(metadata any) any {
		secondCalled = true
		return metadata
	}))
...
func TestPlugin_OnFieldsCalled_NilShortCircuits(t *testing.T) {
	log, _ := setup(t)
	secondCalled := false
	log.AddPlugin(loglayer.NewFieldsHook("drop", func(fields loglayer.Fields) loglayer.Fields {
		return nil
	}))
	log.AddPlugin(loglayer.NewFieldsHook("after-drop", func(fields loglayer.Fields) loglayer.Fields {
		secondCalled = true
		return fields
	}))
	log = log.WithFields(loglayer.Fields{"k": "v"})
...
func TestPlugin_DispatchHookOrdering(t *testing.T) {
	...
	log.AddPlugin(&orderingPlugin{calls: &calls})
	log.Info("ordered")
...
func TestPlugin_TransformLogLevel_SeesMetadataAndErr(t *testing.T) {
	...
	var sawMeta any
	var sawErr error
	log.AddPlugin(loglayer.NewLevelHook("inspect", func(p loglayer.TransformLogLevelParams) (loglayer.LogLevel, bool) {
		sawMeta = p.Metadata
		sawErr = p.Err
		return 0, false
	}))
...
func TestPlugin_Raw_RunsPipeline(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(&rawMutatorPlugin{})
...
func TestPlugin_HookPanicRecovered(t *testing.T) {
	...
	hooks := []struct {
	...
	}{
		{
			...
			plugin: loglayer.NewDataHook("p-bdo", func(p loglayer.BeforeDataOutParams) loglayer.Data { panic("bdo") }),
			emit:   func() { log.Info("ok") },
		},
		{
			name:   "OnBeforeMessageOut",
			plugin: loglayer.NewMessageHook("p-bmo", func(p loglayer.BeforeMessageOutParams) []any { panic("bmo") }),
			emit:   func() { log.Info("ok") },
		},
		{
			name:   "TransformLogLevel",
			plugin: loglayer.NewLevelHook("p-tll", func(p loglayer.TransformLogLevelParams) (loglayer.LogLevel, bool) { panic("tll") }),
			emit:   func() { log.Info("ok") },
		},
		{
			name:   "ShouldSend",
			plugin: loglayer.NewSendGate("p-ss", func(p loglayer.ShouldSendParams) bool { panic("ss") }),
			emit:   func() { log.Info("ok") },
		},
		{
			name:   "OnMetadataCalled",
			plugin: loglayer.NewMetadataHook("p-omc", func(metadata any) any { panic("omc") }),
			emit:   func() { log.WithMetadata(loglayer.Metadata{"k": "v"}).Info("ok") },
		},
		{
			name:   "OnFieldsCalled",
			plugin: loglayer.NewFieldsHook("p-ofc", func(f loglayer.Fields) loglayer.Fields { panic("ofc") }),
	...
	for _, h := range hooks {
		t.Run(h.name, func(t *testing.T) {
			var caught error
			wrapped := loglayer.WithErrorReporter(h.plugin, func(err error) { caught = err })
			log.AddPlugin(wrapped)
			defer log.RemovePlugin(wrapped.ID())
...
// When a plugin doesn't implement ErrorReporter, hook panics are recovered
// and surfaced via the framework's default (stderr); the entry still emits
// and the framework MUST NOT propagate the panic to the caller.
func TestPlugin_HookPanicSilentWhenNoOnError(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewDataHook("panicker", func(p loglayer.BeforeDataOutParams) loglayer.Data { panic("boom") }))

	// Must not panic.
	log.Info("entry")
	if lib.Len() != 1 {
		t.Errorf("entry should still emit even when hook panics: got %d lines", lib.Len())
	}
}
...
func TestPlugin_ShouldSendPanicFailsOpen(t *testing.T) {
	log, lib := setup(t)
	log.AddPlugin(loglayer.NewSendGate("panicker", func(p loglayer.ShouldSendParams) bool { panic("gate-broken") }))
	log.Info("survived")
	if lib.Len() != 1 {
...
func TestPlugin_RecoveredPanicErrorTypedInspection(t *testing.T) {
	...
	log.AddPlugin(loglayer.WithErrorReporter(
		loglayer.NewDataHook("panicker", func(p loglayer.BeforeDataOutParams) loglayer.Data { panic(originalErr) }),
...
func TestPlugin_RecoveredPanicErrorWithNonErrorValue(t *testing.T) {
	...
	var caught error
	log.AddPlugin(loglayer.WithErrorReporter(
		loglayer.NewDataHook("panicker", func(p loglayer.BeforeDataOutParams) loglayer.Data { panic("string-panic") }),
		func(err error) { caught = err },
	))
	log.Info("trigger")
...
// allHooksCtxCapture implements every hook interface; each hook stashes
// the received Ctx into a destination pointer for assertion.
type allHooksCtxCapture struct {
	dataCtx, msgCtx, lvlCtx, sendCtx *context.Context
}

func (a *allHooksCtxCapture) ID() string { return "ctx-capture" }
func (a *allHooksCtxCapture) OnBeforeDataOut(p loglayer.BeforeDataOutParams) loglayer.Data {
	*a.dataCtx = p.Ctx
	return nil
}
func (a *allHooksCtxCapture) OnBeforeMessageOut(p loglayer.BeforeMessageOutParams) []any {
	*a.msgCtx = p.Ctx
	return nil
}
func (a *allHooksCtxCapture) TransformLogLevel(p loglayer.TransformLogLevelParams) (loglayer.LogLevel, bool) {
	*a.lvlCtx = p.Ctx
	return 0, false
}
...
// orderingPlugin implements every dispatch-time hook and appends the hook
// name to a shared slice on each call. Used to verify dispatch order.
type orderingPlugin struct{ calls *[]string }

func (o *orderingPlugin) ID() string { return "ordering" }
func (o *orderingPlugin) OnBeforeDataOut(loglayer.BeforeDataOutParams) loglayer.Data {
	*o.calls = append(*o.calls, "data")
	return nil
}
func (o *orderingPlugin) OnBeforeMessageOut(loglayer.BeforeMessageOutParams) []any {
	*o.calls = append(*o.calls, "messages")
	return nil
}
func (o *orderingPlugin) TransformLogLevel(loglayer.TransformLogLevelParams) (loglayer.LogLevel, bool) {
	*o.calls = append(*o.calls, "level")
	return 0, false
}
func (o *orderingPlugin) ShouldSend(loglayer.ShouldSendParams) bool {
	*o.calls = append(*o.calls, "send")
	return true
}

// rawMutatorPlugin implements DataHook + MessageHook to verify Raw() also
// runs the plugin pipeline.
type rawMutatorPlugin struct{}

func (rawMutatorPlugin) ID() string { return "raw-mutator" }
func (rawMutatorPlugin) OnBeforeDataOut(loglayer.BeforeDataOutParams) loglayer.Data {
	return loglayer.Data{"plugin_added": true}
}
func (rawMutatorPlugin) OnBeforeMessageOut(loglayer.BeforeMessageOutParams) []any {
	return []any{"rewritten"}
}
